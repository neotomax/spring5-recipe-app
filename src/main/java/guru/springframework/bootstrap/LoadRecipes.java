...
public class LoadRecipes implements CommandLineRunner {
    ...
    public LoadRecipes(RecipeRepository recipeRepository, UnitOfMeasureRepository unitOfMeasureRepository, CategoryRepository categoryRepository) {
    ...
    private List<Recipe> addRecipes() {
        ...
        guacamoleRecipe.addIngredient(new Ingredient("Kosher salt", new BigDecimal(".5"), teapoonUom));
